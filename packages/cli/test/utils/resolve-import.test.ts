...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/tintta/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/tintta/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/tintta/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/tintta/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/tintta/Projects/foobar/lib/utils")
})

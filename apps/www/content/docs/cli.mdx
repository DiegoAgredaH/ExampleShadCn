...
```txt
Usage: tintta-widgets init [options]
...
```bash
npx tintta-widgets@latest add [component]
```
...
```txt
Usage: tintta-widgets add [options] [components...]
...
```txt
Usage: tintta-widgets diff [options] [component]
